...
/*!
 @brief QiToast配置管理者
 */
public class QiToastManager {
    
    public static let shared = QiToastManager()
    
    public var style = QiToastStyle()               //!< 弹窗样式定制
    ...
    public var position: QiToastPosition = .center  //!< 弹出的位置
}


// MARK: - Toast Style

public struct QiToastStyle {
